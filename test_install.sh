...
#
        ...
        [yY][eE][sS]|[yY])
            ...
            yum -y install yum-utils wget net-tools gcc gcc-c++ automake autoconf libtool make pam-devel openldap-devel cyrus-sasl-devel openssl-devel >/dev/null 2>&1 & yum update -y nss curl libcurl >/dev/null 2>&1 & echo -ne '#####                     (33%)\r';
sleep 1;
echo -ne '#############             (66%)\r';
sleep 1;
echo -ne '#######################   (100%)\r';
