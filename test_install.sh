...
#
        ...
        [yY][eE][sS]|[yY])
            ...
            wget -nc http://downloads.sourceforge.net/project/ss5/ss5/3.8.9-8/ss5-3.8.9-8.tar.gz | xargs -L 4 | xargs -I@ echo -ne "==...==>>\n"  
            lj=`pwd`
            tar -xzvf ss5-3.8.9-8.tar.gz | xargs -L 4 | xargs -I@ echo -ne "==..TAR -XZVF *.GZ..==>>\n" 
            cd /$lj/ss5-3.8.9/
